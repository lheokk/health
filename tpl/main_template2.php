...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="success">Наш успех заключается не только в <br> качестве и в максимальном комфорте для <br> организаций и частных лиц. В первую <br> очень - это приятные цены.</div>
      ...
      <div class="container">
          ...
          <div class="container">
              <div class="row">
                ...
                <div class="row">
                      <div class="col">
                           <div class="index-text"><h3></h3></div>
                      </div>
                  </div>
